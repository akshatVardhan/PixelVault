...
- [ ] **11** — Foundation: TFLite/ML Kit deps, Room schema v2 (FaceEntity, ClusterEntity, new PhotoEntity columns), DB migration, SettingsDataStore additions, aaptOptions for .tflite
